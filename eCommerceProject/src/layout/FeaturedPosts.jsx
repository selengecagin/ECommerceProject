...
export default function FeaturedPosts() {
  return (
    <main className="flex flex-col items-center px-48 py-28 w-full gap-20">
      <section className="flex flex-col gap-2.5 items-center flex-wrap">
        <h6 className="text-sm font-bold text-center text-[#23A6F0] ">
          Practice Advice
        </h6>
        <h3 className="text-[40px] font-bold text-[#252B42] text-center">
          Featured Posts
        </h3>
